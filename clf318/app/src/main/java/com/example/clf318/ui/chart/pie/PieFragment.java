package com.example.clf318.ui.chart.pie;
...
import com.example.clf318.ui.chart.line.LineViewModel;
...
public class PieFragment extends BaseFragment2 {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        pieViewModel.getPieList().observe(getViewLifecycleOwner(), pieBeans -> {
            ...
            dataSet.setColors(R.color.turquoise,Color.MAGENTA,R.color.crimson,Color.YELLOW);
            ...
            description.setText("Android工程师经验与工资对应的情况");
